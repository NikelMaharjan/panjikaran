...
import 'package:model/constants/fontstyles.dart';
...
class TextStyles {
  ...
  const TextStyle(fontFamily: FontStyles.roboto, fontWeight: FontStyles.bold900);
  static TextStyle headTextStyle1 =
  const TextStyle(fontFamily: FontStyles.roboto, fontWeight: FontStyles.medium400);
